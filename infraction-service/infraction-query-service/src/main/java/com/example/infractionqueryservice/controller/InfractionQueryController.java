...
public class InfractionQueryController {
    ...
    public CompletableFuture<Page> infractionByNationalCardNumber(
                                        ...
                                        @RequestParam(name = "ncid") String cin
                                    ) throws ExecutionException, InterruptedException {
        return queryGateway.query(
                new GetInfractionsByNationalCardNumber(cin,page,size),
    ...
    public Page  getinfractionByNationalCardNumber(
            @RequestParam(name = "page",defaultValue = "0") int page,
            @RequestParam(name = "size",defaultValue = "10") int size,
            @RequestParam(name = "ncid") String cin) throws ExecutionException, InterruptedException {

        return infractionQueryHandler.getinfractions(new GetInfractionsByNationalCardNumber(cin,page,size));
